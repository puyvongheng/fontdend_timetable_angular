...
var NzDescriptionsItemComponent = class _NzDescriptionsItemComponent {
  ...
  static {
    this.ɵfac = function NzDescriptionsItemComponent_Factory(__ngFactoryType__) {
...
var NzDescriptionsComponent = (() => {
  ...
  return class NzDescriptionsComponent2 {
    ...
    constructor(nzConfigService, cdr, breakpointService, directionality) {
      ...
      this.nzBordered = __runInitializers(this, _nzBordered_initializers, false);
      this.nzLayout = (__runInitializers(this, _nzBordered_extraInitializers), "horizontal");
      this.nzColumn = __runInitializers(this, _nzColumn_initializers, defaultColumnMap);
      this.nzSize = (__runInitializers(this, _nzColumn_extraInitializers), __runInitializers(this, _nzSize_initializers, "default"));
      this.nzTitle = (__runInitializers(this, _nzSize_extraInitializers), "");
      this.nzColon = __runInitializers(this, _nzColon_initializers, true);
      this.itemMatrix = (__runInitializers(this, _nzColon_extraInitializers), []);
      this.realColumn = 3;
      this.dir = "ltr";
    ...
    static {
      this.ɵfac = function NzDescriptionsComponent_Factory(__ngFactoryType__) {
        return new (__ngFactoryType__ || NzDescriptionsComponent2)(ɵɵdirectiveInject(NzConfigService), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(NzBreakpointService), ɵɵdirectiveInject(Directionality));
      };
    }
    static {
      this.ɵcmp = ɵɵdefineComponent({
...
var NzDescriptionsModule = class _NzDescriptionsModule {
  static {
    this.ɵfac = function NzDescriptionsModule_Factory(__ngFactoryType__) {

...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(OrganizationChartNode, {
    className: "OrganizationChartNode",
    filePath: "organizationchart.ts",
    lineNumber: 106
  });
})();
var OrganizationChart = class _OrganizationChart extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    features: [ɵɵProvidersFeature([OrganizationChartStyle]), ɵɵInputTransformsFeature, ɵɵInheritDefinitionFeature],
    decls: 2,
    vars: 8,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(OrganizationChart, {
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(OrganizationChartModule, {
    imports: [OrganizationChart, OrganizationChartNode, SharedModule],
    exports: [OrganizationChart, OrganizationChartNode, SharedModule]
  });
})();

import {
  Tooltip,
  TooltipModule
} from "./chunk-TGHGZYNH.js";
import {
  Badge,
  BadgeModule
} from "./chunk-MJBNNMAH.js";
import "./chunk-5G7WYC4N.js";
import {
  AngleDownIcon,
  AngleRightIcon,
  BarsIcon
} from "./chunk-YPSDW7HQ.js";
import {
  Ripple
} from "./chunk-O5ERED2I.js";
import {
  zindexutils
} from "./chunk-NMOYQVAO.js";
import {
  BaseComponent
} from "./chunk-2CMSH67C.js";
import {
  BaseStyle
} from "./chunk-C7PMMXKW.js";
import {
  PrimeTemplate,
  SharedModule,
  findLastIndex,
...
function MegaMenuSub_ul_0_ng_template_3_li_1_ng_container_3_a_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const processedItem_r3 = ɵɵnextContext(3).$implicit;
    const ctx_r1 = ɵɵnextContext(2);
    ɵɵproperty("routerLink", ctx_r1.getItemProp(processedItem_r3, "routerLink"))("queryParams", ctx_r1.getItemProp(processedItem_r3, "queryParams"))("routerLinkActive", "p-megamenu-item-link-active")("routerLinkActiveOptions", ctx_r1.getItemProp(processedItem_r3, "routerLinkActiveOptions") || ɵɵpureFunction0(21, _c4))("target", ctx_r1.getItemProp(processedItem_r3, "target"))("ngClass", ɵɵpureFunction1(22, _c3, ctx_r1.getItemProp(processedItem_r3, "disabled")))("fragment", ctx_r1.getItemProp(processedItem_r3, "fragment"))("queryParamsHandling", ctx_r1.getItemProp(processedItem_r3, "queryParamsHandling"))("preserveFragment", ctx_r1.getItemProp(processedItem_r3, "preserveFragment"))("skipLocationChange", ctx_r1.getItemProp(processedItem_r3, "skipLocationChange"))("replaceUrl", ctx_r1.getItemProp(processedItem_r3, "replaceUrl"))("state", ctx_r1.getItemProp(processedItem_r3, "state"));
    ɵɵattribute("data-automationid", ctx_r1.getItemProp(processedItem_r3, "automationId"))("tabindex", -1)("aria-hidden", true)("data-pc-section", "action");
    ɵɵadvance();
    ɵɵproperty("ngIf", ctx_r1.getItemProp(processedItem_r3, "icon"));
    ɵɵadvance();
...
function MegaMenuSub_ul_0_ng_template_3_li_1_ng_container_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainerStart(0);
    ɵɵtemplate(1, MegaMenuSub_ul_0_ng_template_3_li_1_ng_container_3_a_1_Template, 7, 13, "a", 16)(2, MegaMenuSub_ul_0_ng_template_3_li_1_ng_container_3_a_2_Template, 7, 24, "a", 17);
    ɵɵelementContainerEnd();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(MegaMenuSub, {
    className: "MegaMenuSub",
    filePath: "megamenu.ts",
    lineNumber: 203
  });
})();
var MegaMenu = class _MegaMenu extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    features: [ɵɵProvidersFeature([MegaMenuStyle]), ɵɵInputTransformsFeature, ɵɵInheritDefinitionFeature],
    decls: 8,
    vars: 36,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && ɵsetClassDebugInfo(MegaMenu, {
    className: "MegaMenu",
    filePath: "megamenu.ts",
    lineNumber: 452
  });
...
(function() {
  (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(MegaMenuModule, {
    imports: [MegaMenu, SharedModule],
    exports: [MegaMenu, SharedModule]
  });
})();

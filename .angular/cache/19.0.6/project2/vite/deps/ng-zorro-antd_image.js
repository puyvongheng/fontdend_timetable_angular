...
var NzImageGroupComponent = class _NzImageGroupComponent {
  ...
  static {
    this.ɵfac = function NzImageGroupComponent_Factory(__ngFactoryType__) {
...
var NzImagePreviewComponent = class _NzImagePreviewComponent {
  ...
  static {
    this.ɵfac = function NzImagePreviewComponent_Factory(__ngFactoryType__) {
...
var NzImageService = class _NzImageService {
  ...
  static {
    this.ɵfac = function NzImageService_Factory(__ngFactoryType__) {
...
var NzImageDirective = (() => {
  ...
  return class NzImageDirective2 {
    ...
    constructor(nzConfigService, elementRef, nzImageService, cdr, directionality) {
      ...
      this.nzSrc = "";
      this.nzSrcset = "";
      this.nzDisablePreview = __runInitializers(this, _nzDisablePreview_initializers, false);
      this.nzFallback = (__runInitializers(this, _nzDisablePreview_extraInitializers), __runInitializers(this, _nzFallback_initializers, null));
      ...
      this.nzScaleStep = (__runInitializers(this, _nzPlaceholder_extraInitializers), __runInitializers(this, _nzScaleStep_initializers, null));
      this.dir = __runInitializers(this, _nzScaleStep_extraInitializers);
      this.status = "normal";
    ...
    static {
      this.ɵfac = function NzImageDirective_Factory(__ngFactoryType__) {
...
var NzImageModule = class _NzImageModule {
  static {
    this.ɵfac = function NzImageModule_Factory(__ngFactoryType__) {

...
var NzPopconfirmDirective = (() => {
  ...
  return class NzPopconfirmDirective2 extends _classSuper {
    ...
    constructor() {
      ...
      this.nzPopconfirmBackdrop = __runInitializers(this, _nzPopconfirmBackdrop_initializers, false);
      this.nzAutofocus = (__runInitializers(this, _nzPopconfirmBackdrop_extraInitializers), __runInitializers(this, _nzAutofocus_initializers, null));
      this.visibleChange = (__runInitializers(this, _nzAutofocus_extraInitializers), new EventEmitter());
    ...
    static {
      this.ɵfac = function NzPopconfirmDirective_Factory(__ngFactoryType__) {
...
var NzPopconfirmComponent = class _NzPopconfirmComponent extends NzToolTipComponent {
  ...
  static {
    this.ɵfac = function NzPopconfirmComponent_Factory(__ngFactoryType__) {
...
var NzPopconfirmModule = class _NzPopconfirmModule {
  static {
    this.ɵfac = function NzPopconfirmModule_Factory(__ngFactoryType__) {

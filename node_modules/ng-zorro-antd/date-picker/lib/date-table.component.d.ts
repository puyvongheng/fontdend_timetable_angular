...
export declare class DateTableComponent extends AbstractTable implements OnChanges, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DateTableComponent, "date-table", ["dateTable"], { "locale": { "alias": "locale"; "required": false; }; "format": { "alias": "format"; "required": false; }; }, {}, never, never, true, never>;
}
